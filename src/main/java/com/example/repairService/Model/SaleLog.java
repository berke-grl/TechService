...
public class SaleLog {
    ...
    public SaleLog(Date sale_log_date, String credit_card, long sale_id, long user_id) {
    ...
    public SaleLog(long id, Date sale_log_date, String credit_card, long sale_id, long user_id) {
        this.id = id;
        this.sale_log_date = sale_log_date;
        this.credit_card = credit_card;
        this.sale_id = sale_id;
